  ...
  return (
    <div className="rounded border border-polar-700 bg-polar-900 p-5 shadow-none">
      ...
      <div className="flex flex-wrap items-center justify-between gap-2 mb-4 pb-3 border-b border-polar-800">
        ...
        <div className="flex items-center gap-2">
          <span className="text-[11px] text-polar-400 font-mono">Recovery State</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-5">
        ...
        <div className="rounded border border-rose-900/70 bg-polar-950/60 p-4 flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between gap-2 mb-2">
              <span className="text-[11px] font-mono font-bold text-polar-300 uppercase tracking-wider">
                ACTIVE WORK ORDER
              </span>
              <span className="px-1.5 py-0.5 rounded text-[9px] font-mono font-bold bg-rose-950 text-rose-300 border border-rose-800 uppercase tracking-wider">
          ...
          <div className="mt-4 pt-3 border-t border-polar-800/80 text-[10px] font-mono text-polar-500">
            Work order scheduled &middot; Priority: HIGH
          </div>
        </div>

        {/* 2. Spare Part & Inventory */}
        <div className="rounded border border-amber-900/70 bg-polar-950/60 p-4 flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between gap-2 mb-2">
              <span className="text-[11px] font-mono font-bold text-polar-300 uppercase tracking-wider">
                REQUIRED SPARE PART
          ...
          <div className="mt-4 pt-3 border-t border-polar-800/80 text-[10px] font-mono text-rose-400 font-semibold">
            Inventory depletion blocking recovery
          </div>
        </div>

        {/* 3. Resupply Exposure */}
        <div className="rounded border border-polar-800 bg-polar-950/60 p-4 flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between gap-2 mb-2">
              <span className="text-[11px] font-mono font-bold text-polar-300 uppercase tracking-wider">
                RESUPPLY LOGISTICS
              </span>
              <span className="px-1.5 py-0.5 rounded text-[9px] font-mono font-bold bg-cyan-950 text-cyan-300 border border-cyan-800 uppercase tracking-wider">
                IN TRANSIT
              </span>
            </div>
          ...
          <div className="mt-4 pt-3 border-t border-polar-800/80 text-[10px] font-mono text-polar-400">
      ...
      <div className="rounded border border-polar-800 bg-polar-950 p-4">
        <div className="text-[11px] font-mono font-bold text-polar-300 uppercase tracking-wider mb-2">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs font-mono text-polar-300">
          <div className="flex items-start gap-2 p-2.5 rounded bg-polar-900 border border-polar-800">
            ...
            <div>
              ...
              <span className="text-polar-300">De-rate G-02 electrical load to 65 kW to minimize bearing vibration and thermal runaway.</span>
            </div>
          </div>
          ...
          <div className="flex items-start gap-2 p-2.5 rounded bg-polar-900 border border-polar-800">
            ...
            <div>
              ...
              <span className="text-polar-300">Initiate Boiler B-01 preheat sequence (requires 35m in -28°C) to safeguard Zone 2 heating.</span>
            </div>
          </div>
        </div>
      </div>
