...
export const demoStationData = {
  active: "BHARATI", season: "WINTER", connectivity: "CONNECTED", sync: "SYNCHRONIZED",
  stations: [
...
export const demoG02 = {
  id: "G-02", name: "DIESEL GENERATOR G-02", status: "CRITICAL" as Status,
  telemetry: [
    ["Bearing vibration", "+3.1% deviation"], ["Power contribution", "42%"],
    ["Dependency", "Power Bus A"], ["Warning threshold", "+2.5%"],
  ],
  condition: [["Power output", "520 kW"], ["Vibration", "+3.1%"], ["Temperature", "74°C"], ["Runtime", "4,821 h"], ["Fuel flow", "82 L/h"]],
};

export const demoTimeline = [
  ["14:22:07", "Anomaly detected"], ["14:22:31", "Operating context evaluated"],
  ["14:23:04", "Power dependency identified"], ["14:23:28", "Impact scenario generated"],
  ["14:24:10", "Operational recommendation created"], ["14:24:42", "Human review required"],
];
...
export const demoResources = [
  ["FUEL", 68, "WARNING", "1,320 L/day", "81 days"], ["POWER", 84, "NOMINAL", "1,240 kW", "N+1 generation"],
  ["WATER", 74, "NOMINAL", "4.2 m³/day", "31 days"], ["FOOD", 82, "NOMINAL", "126 kg/day", "104 days"],
